...
Semantic HTML is used to decribe elements and the kind of content that is in them and gives the page meaning.
...
Git allows developers to have saving points in a project as well as allow for easy sharing and merging of files

5. Define mobile-first design in your own words.
Mobile-first design is when you design for the mobile screen before a destop or other devices such as tablets.
